...
public class SingleChoiceQAViewController : QuesAnsViewController {
	//Display Variables
	int totalOptionCount = 4;
	float currentTime=0,totalTime=0,maxCurrentTime = 90;
	QuesAnsList quesAnsList ;
	SingleChoiceQANetworkController commonQANetworkObject;
	...
	public override void setQAList(){
		...
		commonQANetworkObject = (SingleChoiceQANetworkController) gameObject.GetComponent(typeof(SingleChoiceQANetworkController));
		quesAnsList = new QuesAnsList();
