...
using System.Linq;
using SimpleJSON;
public class SingleChoiceQANetworkController : MonoBehaviour {

	public static readonly string domain = "localhost:3000";
	SingleChoiceQAViewController commonQAViewCtrl;
	...
	IEnumerator getQAListNetworkCall(QuesAnsList quesAnsList) {
		commonQAViewCtrl = (SingleChoiceQAViewController) gameObject.GetComponent(typeof(SingleChoiceQAViewController));;
