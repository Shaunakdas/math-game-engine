...
using System.Linq;
using SimpleJSON;
public class EquivalenceQANetworkController : MonoBehaviour {

	public static readonly string domain = "localhost:3000";
	EquivalenceQAViewController commonQAViewCtrl;
	...
	IEnumerator getQAListNetworkCall(QuesAnsList quesAnsList) {
		commonQAViewCtrl = (EquivalenceQAViewController) gameObject.GetComponent(typeof(EquivalenceQAViewController));;
